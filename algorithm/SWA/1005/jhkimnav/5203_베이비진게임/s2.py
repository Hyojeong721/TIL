...
for tc in range(1, T+1):
    ...
    for i in range(len(card_list) // 2):
        ...
        if i >= 2:
            ...
            # print(player2)
            # print(nPr1)
            # print('Player 1 결과 : {}'.format(is_run_or_triplet(list(nPr1))))
            # print('Player 2 결과 : {}'.format(is_run_or_triplet(list(nPr2))))
            # print('대결 : {}'.format(is_run_or_triplet(list(nPr1)) > is_run_or_triplet(list(nPr2))))
